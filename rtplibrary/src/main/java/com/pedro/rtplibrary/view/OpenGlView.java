...
public class OpenGlView extends SurfaceView
  ...
  readyToStreaam  readyStreamListener;

  public void addSurfaceReadyHandler( readyToStreaam readyStreamListener ){
this.readyStreamListener = readyStreamListener;
  ...
  public void setEncoderSize(int width, int height) {
    ...
    Log.d("READY_SURFAC" , "___"  + width + " " + height);
    readyStreamListener.sizeChanged(width / 2 , height/2);
  }
...
//    Log.d("READY_SURFAC" , "___"  + this.previewWidth + " " + this.previewHeight);
//    readyStreamListener.sizeChanged(width , height);
  }

  @Override
  public void surfaceCreated(SurfaceHolder holder) {

    readyStreamListener.iAmRead();
  }
